...
export class FuseProgressBarService
{
    ...
    show(): void
    {
        this._mode.next('indeterminate');
        this._visible.next(true);
        document.getElementById('vertical-layout-1-progressbar').style.pointerEvents = 'none';
    ...
    hide(): void
    {
        ...
        document.getElementById('vertical-layout-1-progressbar').style.pointerEvents = 'auto';
    }
